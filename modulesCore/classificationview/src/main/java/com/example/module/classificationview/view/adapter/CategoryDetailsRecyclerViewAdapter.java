...
public class CategoryDetailsRecyclerViewAdapter extends RecyclerView.Adapter<CategoryDetailsRecyclerViewAdapter.CategoryDetailsRecyclerViewHolder> {
    ...
    @NonNull
    @Override
    public CategoryDetailsRecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CategoryDetailsRecyclerViewHolder holder, int position) {
